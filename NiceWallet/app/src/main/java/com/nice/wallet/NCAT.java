 ...
 * {@link NCAT.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NCAT#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NCAT extends Fragment {
     ...
     * @return A new instance of fragment NCAT.
     */
    // TODO: Rename and change types and number of parameters
    public static NCAT newInstance(String param1, String param2) {
        NCAT fragment = new NCAT();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* View fragView=inflater.inflate(R.layout.fragment_jir, container, false);
        ...
        String[] row = { "172.30.16.61", "172.30.16.11", "172.30.16.55"};
        String[] column = { "Sr. No", "Hostname" };
